...
class Calculator {
  ...
  processOperation(operation) {
    ...
    let operationValue
    let previous = Number(this.previousOperationText.innerText.split(" ")[0])
    let operator = this.previousOperationText.innerText.split(" ")[1]
    let current = Number(this.currentOperationText.innerText)
